...
public class Exploration_Licence extends GlobalVariables {
	...
	public Exploration_Licence (String username, String password, String user) {
	...
	@Test
	@Parameters({ "pCategoryName", "pCustomerType", "pCustomerID", "pScaleOfOperation", "pMineralsType" })
	public void explorationLarge_Radioactive(String categoryName2, String customerType2, String customerID2, String scaleOfOperation2, String mineralsType2) {

		serviceForms.caseDetailsForm(categoryName2, customerType2, customerID2);
		serviceForms.applicationFormLargeRadioactive(categoryName2);
		serviceEligibility.eligibilityVerification(categoryName2, customerType2, scaleOfOperation2, mineralsType2);

	}
	
	/*
	 * 	<parameter name="CategoryName" value="Exploration Licence" />
	<parameter name="Customer" value="Individual" />
	<parameter name="CustomerID" value="727110111" />
	<parameter name="ScaleOfOperation" value="Large" />
	<parameter name="MineralsType" value="Non-Radioactive" />
	 */
